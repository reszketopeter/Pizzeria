...
public class ProductController {
        ...
        @Operation(summary = "Create new product", description = "Creates a new product based on the provided data.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Create new products", description = "Creates new products based on the provided data.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Get product by name", description = "Retrieves product details based on the category name.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Update product", description = "Updates product details based on the provided name and data.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Update products", description = "Updates products details based on the provided data.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Delete product by ID", description = "Deletes a product from the system based on their ID.")
        @ApiResponses(value = {
         ...
         * 2. The backend receives the image and transfers it to the file storage server
