...
public class OrderController {
        ...
        @Operation(summary = "Create new order", description = "Creates a new order for the specified product and customer.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Mark order as delivered", description = "Updates the status of an order to 'delivered' for the specified customer and order ID.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Cancel order", description = "Cancels the current customer's active order based on session data.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Get order by ID", description = "Retrieves detailed information about an order based on its ID.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Delete order by ID", description = "Deletes an order from the system based on its ID.")
        @ApiResponses(value = {
