...
public class CustomerController {
        ...
        @Operation(summary = "New customer registration", description = "The new customer is registered based on the provided data.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Get customer by ID", description = "Returns detailed information about a customer based on their ID.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Update customer email", description = "Updates the email address of a customer based on their ID.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Delete customer by ID", description = "Deletes a customer from the system based on their ID.")
        @ApiResponses(value = {
